    ...
    <AdminLayout>
      ...
      <main style={mainContent}>
        ...
        <div style={titleSection}>
          <h2 style={pageTitle}>Edit Guru BK</h2>
          <nav style={breadcrumb}>
            <span style={breadcrumbItem}>Dashboard</span>
            <span style={breadcrumbSeparator}>&rsaquo;</span>
            <span style={breadcrumbItem}>Data Guru BK</span>
            <span style={breadcrumbSeparator}>&rsaquo;</span>
            <span style={breadcrumbActive}>Edit Guru BK</span>
          </nav>
        </div>
        ...
        <div style={card}>
          <form onSubmit={handleSubmit}>
            ...
            {/* Mengampu Kelas */}
            <div style={formGroup}>
              <label style={label}>Mengampu kelas</label>
...
/>
            ...
            {/* Upload Foto Baru */}
            <div style={formGroup}>
              <label style={label}>Upload foto baru (opsional)</label>
              <div 
                style={{
                  ...uploadBox,
                  ...(dragActive ? uploadBoxActive : {}),
                  ...(foto ? uploadBoxHasFile : {})
                }}
              ...
              >
                ...
                <div style={uploadContent}>
                  ...
                  {foto && (
                    <p style={fileName}>{foto.name}</p>
                  )}
                  {!foto && fotoLama && (
                    <p style={fileName}>Biarkan kosong untuk tetap pakai foto lama</p>
                  )}
                </div>
              </div>
            </div>
...
// Styles (SAMA PERSIS dengan Tambah Guru)
const pageWrapper = {
  background: "#e8e8e8",
  minHeight: "100vh",
