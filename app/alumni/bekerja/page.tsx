...
export default function Page() {
  ...
  useEffect(() => {
    fetch(
  `${api}/api/alumni?status=BEKERJA&statusPengajuan=DITERIMA`
)
      .then((r) => r.json())
  ...
  return (
    <div style={{ background: "#e8e8e8", minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      <div style={{
        ...
        <h2 style={{ margin: "0 0 8px", fontSize: 24, fontWeight: 700 }}>Alumni Bekerja</h2>
        <p style={{ margin: 0, opacity: 0.85, fontSize: 14 }}>Total {data.length} alumni telah berkarir di dunia kerja</p>
      </div>
              ...
              <table style={{
                ...
                <thead>
                  <tr style={{ background: "#6b7c4e", color: "white" }}>
                    ...
                    <th style={{ padding: "16px", textAlign: "left", fontSize: 13, fontWeight: 600 }}>Perusahaan</th>
                ...
                <tbody>
                  {filtered.map((a, i) => (
                    <tr key={a.id} style={{ borderBottom: "1px solid #f0f0f0" }}>
                      ...
                      <td style={{ padding: "16px", color: "#444", fontSize: 13 }}>{a.namaPerusahaan || "-"}</td>
                      <td style={{ padding: "16px", color: "#444", fontSize: 13 }}>{a.tahunMasukKerja || "-"}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
