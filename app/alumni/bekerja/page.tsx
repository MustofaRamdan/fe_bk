...
export default function Page() {
  ...
  useEffect(() => {
    fetch(`${api}/api/alumni?status=BEKERJA&statusPengajuan=DITERIMA`)
      .then((r) => r.json())
  ...
  return (
    <DesktopLayout>
      ...
      <div className="alumni-hero">
        ...
        <h2 className="hero-title">Alumni Bekerja</h2>
        <p className="hero-subtitle">
          Mencatat karir gemilang alumni yang telah berkontribusi aktif di berbagai industri.
        </p>
      ...
      <div className="tabs-container">
        <button onClick={() => router.push("/alumni/kuliah")} className="tab-button">
          Kuliah
        </button>
      ...
      <div className="search-section">
        <div className="search-wrapper">
          ...
          <input
            placeholder="Cari nama atau nama perusahaan..."
            value={search}
      ...
      <div style={{ padding: "0 20px 40px" }}>
        {loading ? (
          ...
          <div className="state-container empty">
            ...
            <p>Tidak ada data alumni bekerja yang sesuai</p>
          </div>
        ) : (
          <>
