...
export default function Page() {
  ...
  useEffect(() => {
    fetch(`${api}/api/alumni?status=WIRAUSAHA&statusPengajuan=DITERIMA`)
      .then((r) => r.json())
  ...
  return (
    <DesktopLayout>
      ...
      <div className="alumni-hero">
        ...
        <h2 className="hero-title">Alumni Wirausaha</h2>
        <p className="hero-subtitle">
          Mencatat rekam jejak alumni kreatif yang mandiri membangun dan mengembangkan bisnis sendiri.
        </p>
      ...
      <div style={{ padding: "0 20px 40px" }}>
        {loading ? (
          ...
          <div className="state-container empty">
            ...
            <p>Tidak ada data alumni wirausaha yang sesuai</p>
          </div>
        ) : (
          <>
                ...
                <div key={a.id} className="alumni-grid-card">
                  ...
                  <div className="card-details">
                    ...
                    <div className="detail-item">
                      ...
                      <div className="detail-content">
                        <label>Berdiri Sejak (Tahun)</label>
                        <p>{a.tahunAwalUsaha || "-"}</p>
                      </div>
                    </div>
                  </div>
                </div>
